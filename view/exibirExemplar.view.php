    ...
    <div class="row content">
        ...
        <div id="conteudoPrincipal" class="col-md-10 text-left">
            ...
            <div id="DivRegistroTabela" class="container col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Lista de Exemplares Cadastrados</h1>
                        <hr id="hrRegistros">
                        ...
                        <td>$livro->tipo</td>
                        <td><a href='../arquivos/exemplar/".$livro->idExemplar."/".$livro->arquivoDigital."' download >".$livro->arquivoDigital."</a></td>
                        <td>$livro->status</td>
                        <td><a href='../view/cadastroExemplar.view.php?id=".$livro->idExemplar."'><i class='glyphicon glyphicon-pencil'></i>  Alterar</a></td>
                        <td><a  data-toggle='modal' data-target='#myModal".$livro->idExemplar."' id='tdRemover' href='#?id=".$livro->idExemplar."'><i class='glyphicon glyphicon-remove'></i>  Remover</a></td>
                    </tr>
                    <!-- Modal -->
                    <div id='myModal".$livro->idExemplar."' class='modal fade' role='dialog'>
                        <div class='modal-dialog'>
                            ...
                            <div class='modal-content'>
                                ...
                                <div id='rodapeModal' class='modal-footer'>
                                    <a id='aBotaoRemover' class='btn btn-warning' href='../controller/Exemplar.action.php?act=del&id=".$livro->idExemplar."'>Remover</a>
